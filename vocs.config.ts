    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          collapsed: false,
          items: [
            { text: 'Overview', link: '/account-security/overview' },
            {
              text: 'For Individuals',
              collapsed: true,
              items: [
                { text: 'Overview', link: '/account-security/individuals/overview' },
                { text: 'Discord', link: '/account-security/individuals/discord' },
                { text: 'GitHub', link: '/account-security/individuals/github' },
                { text: 'GoDaddy', link: '/account-security/individuals/godaddy' },
                { text: 'Google', link: '/account-security/individuals/google' },
                { text: 'Linear', link: '/account-security/individuals/linear' },
                { text: 'Mercury', link: '/account-security/individuals/mercury' },
                { text: 'Notion', link: '/account-security/individuals/notion' },
                { text: 'Render', link: '/account-security/individuals/render' },
                { text: 'Sentry', link: '/account-security/individuals/sentry' },
                { text: 'Signal', link: '/account-security/individuals/signal' },
                { text: 'Telegram', link: '/account-security/individuals/telegram' },
                { text: 'Trello', link: '/account-security/individuals/trello' },
                { text: 'Vercel', link: '/account-security/individuals/vercel' },
                { text: 'X (Twitter)', link: '/account-security/individuals/twitter-x' },
              ]
            },
            {
              ...
              collapsed: true,
              items: [
                { text: 'Overview', link: '/account-security/organizations/overview' },
                { text: 'Discord', link: '/account-security/organizations/discord' },
                { text: 'GitHub', link: '/account-security/organizations/github' },
                { text: 'GoDaddy', link: '/account-security/organizations/godaddy' },
                { text: 'Google Workspace', link: '/account-security/organizations/google' },
                { text: 'Linear', link: '/account-security/organizations/linear' },
                { text: 'Mercury', link: '/account-security/organizations/mercury' },
                { text: 'Notion', link: '/account-security/organizations/notion' },
                { text: 'Render', link: '/account-security/organizations/render' },
                { text: 'Sentry', link: '/account-security/organizations/sentry' },
                { text: 'Slack', link: '/account-security/organizations/slack' },
                { text: 'Telegram', link: '/account-security/organizations/telegram' },
                { text: 'Vercel', link: '/account-security/organizations/vercel' },
                { text: 'X (Twitter)', link: '/account-security/organizations/twitter-x' },
              ]
            },
          ]
        },
