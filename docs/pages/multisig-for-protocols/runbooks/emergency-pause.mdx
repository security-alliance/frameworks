...
| ------- | ------- |
| **Severity** | EMERGENCY |
| **Response Time** | Defined by your incident-response policy (e.g. \<2 hs) |
| **Required Threshold** | Use the threshold and signer path predefined for this multisig |
| **Owner** | Security Team |
| **Last Updated** | _Date_ |
...
<Checklist id="2-assess-situation">
...
<Checklist id="sign-and-communicate">
...
<Checklist id="immediate-within-1-hour">
...
<Checklist id="short-term-within-24-hours">
- [ ] Root cause analysis
- [ ] Plan for resolution
