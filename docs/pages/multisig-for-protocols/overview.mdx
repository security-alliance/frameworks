...
- Need to sign a transaction? → Signing & Verification: [Safe
  Multisig](/wallet-security/secure-multisig-safe-verification) and
  [Squads](/wallet-security/secure-multisig-squads-verification)
...
- [Safe Multisig: Step-by-Step Verification](/wallet-security/secure-multisig-safe-verification) - Safely verify and
  sign transactions
