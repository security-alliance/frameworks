...
- Need to sign a transaction? → Signing & Verification: [Safe Multisig](/wallet-security/signing-and-verification/secure-multisig-safe-verification) and [Squads](/wallet-security/signing-and-verification/secure-multisig-squads-verification)
...
- [Safe Multisig: Step-by-Step Verification](/wallet-security/signing-and-verification/secure-multisig-safe-verification) - Safely verify and sign transactions
