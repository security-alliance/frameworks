...
description: "Document multisig setup: registration templates with address, threshold, classification, signer verification signatures, controlled contracts, and impact assessment. Update templates for signer changes."
tags:
  - Engineer/Developer
  - Security Specialist
  - Multisig Security
