...
Record your classification decision in the [Registration template](/multisig-for-protocols/registration-and-documentation.md#registration-template).
...
This classification will guide your threshold selection ([Section 2.1](/multisig-for-protocols/general-rules#thresholds--configuration)), signer requirements, and operational procedures throughout the rest of this guide.
