...
This classification will guide your threshold selection ([Thresholds & Configuration](/multisig-for-protocols/general-rules#thresholds--configuration)), signer requirements, and operational procedures throughout the rest of the documentation.
