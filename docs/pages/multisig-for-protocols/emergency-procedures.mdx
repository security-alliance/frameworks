...
4. **Execute replacement** - Replace compromised signer on multisig, following steps for signer rotation in [General Rules](/multisig-for-protocols/general-rules)
...
- [Seed Phrase & Private Key Management](/wallet-security/private-key-management) - Key recovery procedures
