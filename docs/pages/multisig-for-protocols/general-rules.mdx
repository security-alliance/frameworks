...
- In the event of loss of access to keys or potential compromise of keys or communication channels, the signer must immediately notify the other multisig participants and emailing your security contact - [4.8 Incident Reporting](/multisig-for-protocols/incident-reporting)
...
- The signer must follow the steps in [3.3 Signer Verification process](/multisig-for-protocols/registration-and-documentation#signer-verification-process)
...
- All signers should complete training as outlined in this guide - [Implementation Checklist](/multisig-for-protocols/implementation-checklist)
