...
- [ ] I have established procedures for regular reviews and updates per [Ongoing Management](/multisig-for-protocols/ongoing-management)
- [ ] I have set up backup infrastructure and tested alternative UIs per [Backup Infrastructure](/multisig-for-protocols/backup-infrastructure)
...
- [ ] I have stored my seed phrase securely using approved methods from [Seed Phrase & Private Key Management](/wallet-security/private-key-management)
...
- [ ] I can use approved verification tools (Safe CLI Utils, OpenZeppelin SafeUtils for EVM) from [Transaction Verification & Signing](/multisig-for-protocols/transaction-verification-and-signing)
...
- [ ] I have downloaded backup UIs (Eternal Safe for EVM, Squads public client for Solana) per [Backup Infrastructure](/multisig-for-protocols/backup-infrastructure)
- [ ] I know how to sign transactions when primary UI is down per [Signing When UI is Down](/multisig-for-protocols/signing-when-ui-is-down)
...
- [ ] I understand timelock configuration per [Timelock Configuration](/multisig-for-protocols/timelock-configuration)
...
- [ ] [Private Key Management](/wallet-security/private-key-management) - Key protection procedures
- [ ] [Transaction Verification & Signing](/multisig-for-protocols/transaction-verification-and-signing) - Signing procedures
...
- [ ] [Timelock Configuration](/multisig-for-protocols/timelock-configuration) (if applicable)
