...
- Screen lock after 5 minutes of inactivity on computers, 30 seconds on mobile
...
**Signal with verified safety numbers** for multisig communications: You MUST check the codes with the
person you are interacting with to verify them.
