...
- [ ] All signer addresses added and [verified](/multisig-for-protocols/registration-and-documentation.md#signer-verification-process)
...
3. [Hardware Wallet Setup](/multisig-for-protocols/hardware-wallet-setup) - Ensure all signers are properly configured
