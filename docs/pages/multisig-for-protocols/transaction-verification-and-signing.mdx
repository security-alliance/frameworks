...
Proper transaction verification protects against UI compromise attacks and ensures you're signing exactly what you intend. This page covers verification procedures for both EVM and Solana networks.
...
This section helps you verify Squads multisig proposals and signatures to ensure:
...
![Squads signing interface](https://frameworks-static.s3.us-east-2.amazonaws.com/images/multisig-for-protocols/squads-signing-interface.png)
...
- [Hardware Wallet Setup](/multisig-for-protocols/hardware-wallet-setup) - Device configuration for signing
- [Backup Signing & Infrastructure](/multisig-for-protocols/backup-signing-and-infrastructure) - Using backup interfaces
- [Emergency Procedures](/multisig-for-protocols/emergency-procedures) - Emergency signing procedures
- [Backup Signing & Infrastructure](/multisig-for-protocols/backup-signing-and-infrastructure) - Alternative verification tools
