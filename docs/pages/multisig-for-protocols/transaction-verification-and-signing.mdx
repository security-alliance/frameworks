...
- [Signing When UI is Down](/multisig-for-protocols/signing-when-ui-is-down) - Using backup interfaces
- [Emergency Procedures](/multisig-for-protocols/emergency-procedures) - Emergency signing procedures
- [Backup Infrastructure](/multisig-for-protocols/backup-infrastructure) - Alternative verification tools
