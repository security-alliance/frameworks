---
title: "Technical"
description: "Technical controls: device hardening, network security, encrypted storage, MFA with hardware keys, and cryptocurrency-specific wallet security. Includes cold storage and multi-signature best practices."
tags:
  - Security Specialist
  - Operations & Strategy
  - Devops
