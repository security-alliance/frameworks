...
1. [Device and Endpoint Security](/opsec/old/device-endpoint-security/README) for device hardening practices
2. [Digital Identity and Access Management](/opsec/old/digital-identity-access/README) for authentication during travel
3. [Physical Security](/opsec/old/physical-security/README) for protecting physical assets
