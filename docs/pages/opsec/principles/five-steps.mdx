...
> **🔗 Related Framework:** This step aligns with [Asset Inventory](/infrastructure/asset-inventory) practices and informs [Data Protection](/opsec/old/data-protection/README) strategies.
...
> **🔗 Related Framework:** For comprehensive approaches, see [Governance]() {/*TODO: link not found:/governance/README*/} and [Risk Management]() {/*TODO: link not found:../governance/risk-management.md */} frameworks.
...
> **🔗 Related Framework:** Implementation connects with [Security Automation](/security-automation/README) and various control frameworks like [Infrastructure](/infrastructure/README) and [Identity and Access Management](/iam/README).
