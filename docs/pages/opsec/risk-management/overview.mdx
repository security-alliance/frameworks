...
description: "OpSec risk management: impact analysis, likelihood determination, risk calculation, prioritization methodology, and trade-off analysis. Includes Web3-specific risks for smart contracts and private keys."
tags:
  - Security Specialist
  - Operations & Strategy
  - Devops
...
- [Risk Assessment & Prioritization](/opsec/risk-management/risk-assessment-prioritization) — convert threat
intelligence into ranked action plans.
- [Trade-off Analysis](/opsec/risk-management/trade-off-analysis) — balance security investment against usability,
speed, and cost.
...
> Modeling](/opsec/threat-modeling-overview).
