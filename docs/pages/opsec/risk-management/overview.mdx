...
- [Risk Assessment & Prioritization](/opsec/risk-management/risk-assessment-prioritization) — convert threat intelligence into ranked action plans.
- [Trade-off Analysis](/opsec/risk-management/trade-off-analysis) — balance security investment against usability, speed, and cost.

## Risk Assessment Process

{/* ![Risk Management Process](../../assets/risk-management-process.png) */}

> **🔗 Related Framework:** This process builds directly on outputs from [Threat Modeling](/opsec/threat-modeling-overview).
