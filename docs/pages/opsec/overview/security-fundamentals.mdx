...
This document outlines the foundational security approaches that should be embedded throughout your organization's operations. They complement the practical [Operational Implementation Process](/opsec/overview/implementation-process), which defines specific action steps:
...
For organizations just beginning their security journey, start with the [Operational Implementation Process](/opsec/overview/implementation-process) for concrete steps.
...
> **🔗 Related Framework:** This approach is reinforced in frameworks like [Infrastructure](../infrastructure/README) with [Zero-Trust Principles](../infrastructure/zero-trust-principles) and [Network Security](../infrastructure/network-security).
...
> **🔗 Related Framework:** For detailed implementation, see [Identity and Access Management](/iam/README) and [Role-Based Access Control](/iam/role-based-access-control).
...
> **🔗 Related Framework:** This approach is supported by practices in [Data Protection](../operational-security/data-protection/) and aspects of [Privacy](../privacy/). {/* TODO: where does this link take? */}
