...
This document outlines a practical implementation process for operational security that organizations can follow in sequence. This process complements the [Security Fundamentals](/opsec/overview/security-fundamentals) document, which defines the guiding principles:
...
> **🔗 Related Framework:** This phase integrates with [Asset Inventory](/infrastructure/asset-inventory) practices and drives [Data Protection](../operational-security/data-protection/) strategies. {/* TODO: understand link data protection*/}
...
> **🔗 Related Framework:** For hands-on approaches, see [Understanding Threat Vectors](/awareness/understanding-threat-vectors) and [Threat Modeling](/opsec/threat-modeling-overview) frameworks.
...
> **🔗 Related Framework:** This aligns with the [Security Testing](/security-testing/README) framework and includes practices like [Static Application Security Testing](/security-testing/static-application-security-testing) and [Dynamic Application Security Testing](/security-testing/dynamic-application-security-testing). {/*TODO: what are the last 2 links*/}
...
> **🔗 Related Framework:** For practical approaches, see [Governance](/governance/README) and [Risk Management](/governance/risk-management) frameworks.
...
> **🔗 Related Framework:** Implementation integrates with [Security Automation](/security-automation/README) and control frameworks like [Infrastructure](/infrastructure/README) and [Identity and Access Management](/iam/README).
