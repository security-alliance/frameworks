...
As noted above, MFA is necessary but not sufficient as an OpSec strategy. That said, if you have not yet
implemented MFA you are making a grave mistake. Changing course had better be the first thing on your agenda
as soon as you stop reading this article.
...
2. **TOTP (e.g., Google Authenticator) is good but not great.** Why? It is easy enough to trick users into
   entering TOTP codes into a phishing site. The methods cited below are more difficult to exploit.
...
Once you have MFA in place, you are ready to move on to the next step. However, before you declare your MFA
