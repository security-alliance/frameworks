...
Getting started with an enterprise password manager is simple - choose amongst the options based on your particular use case. Bitwarden supports self-hosting, as do alternatives like Vaultwarden and Passbolt. Each product/project has its own unique capabilities amongst those listed above.
