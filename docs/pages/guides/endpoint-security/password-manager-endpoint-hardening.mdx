...
<Checklist id="minimum-device-baseline">
...
<Checklist id="safer-browser-and-vault-usage">
...
<Checklist id="clipboard-and-copypaste-hygiene">
...
<Checklist id="protecting-the-password-manager-account">
