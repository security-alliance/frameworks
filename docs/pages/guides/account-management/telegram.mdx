...
- [ ]  **Exercise Caution with Mini Apps:** Avoid logging in or
  ...
  Never enter or send a login code, Two-Step Verification password,
  seed phrase, private key, or recovery phrase to a Mini App; no
  legitimate Mini App needs them.
