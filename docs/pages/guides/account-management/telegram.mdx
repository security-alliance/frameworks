  ...
  - Privacy & Security >
    - Security >
      ...
      - [ ]  Passkeys > **Set up at least one passkey**
        ...
        (Face ID, fingerprint) or a device PIN instead of SMS codes. This is **phishing-resistant** and eliminates
        SIM-swapping risk entirely for login.
        ...
        from another.
        - **Keep your phone number active.** Even with passkeys, your account is still tied to a phone number.
        Ensure it remains under your control.
        - Passkeys work offline and across regions — useful when traveling or when SMS delivery is unreliable.
