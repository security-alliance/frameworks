...
- [ ] User Settings > Account > Password & Security > Multi-Factor Authentication: Ensure **2FA** is enabled (authenticator app and/or security key), Remove a phone
...
<Checklist id="safety-setup-2">
  ...
  - [ ] Set to at least **Medium** (regist ered on Discord for 5+ minutes) — Recommended: "Moderate" for public servers
