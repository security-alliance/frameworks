...
particular rules. Beemo is a good example of a bot in this category. A popular bot in this category is [Wick Bot](https://wickbot.com/).
...
#### Moderation & Anti-Link (Allowlisting link Bots)

Elevated permissions can be gained via a succesfull 2FA Session via these bots and only allows approved links are allowed to be sent in a discord server. A popular bot in this category is [ZTS Guard Bot](https://zts-guard.gitbook.io/zts-guard-discord-bot) or [Goodknight Bot](https://docs.goodknightbot.com/).

#### General Moderation Bots

Consider bots like [Dyno](https://dyno.gg/) or [ZTS Guard Bot](https://zts-guard.gitbook.io/zts-guard-discord-bot) for advanced moderation and logging, or [Carl-bot](https://carl.gg/) for reaction roles and custom commands. Set
