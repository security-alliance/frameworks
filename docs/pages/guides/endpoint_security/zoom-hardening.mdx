...
- [ ] **Deploy PPPC profiles / revoke Zoom TCC permissions (macOS)**: Use the PPPC profiles and `tccutil` scripts from the [macOS-specific mitigations](#macos-specific-mitigations) section below to block or revoke Zoom's accessibility permissions.
- [ ] **Remove Zoom desktop client when possible**: If your workflow allows it, uninstall the desktop client entirely to eliminate the attack surface. See [Complete Zoom uninstallation](#complete-zoom-uninstallation) below.
