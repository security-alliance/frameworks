...
Click one field. The map keeps the related fields in the other columns and dims the rest. The
panel on the right names the field and counts connected attack surfaces, threats, controls,
incidents, and guidance. Shareable URLs may include `focus`. They never include assessment state.
