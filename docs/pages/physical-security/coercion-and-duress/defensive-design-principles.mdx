...
- [Coercion & Duress overview](/physical-security/coercion-and-duress/overview): how the pages of this sub-section fit
  together
- [Wallet and Key Architecture](/physical-security/coercion-and-duress/wallet-and-key-architecture): minimization and
  compartmentalization applied to keys
- [Transaction Flows Under Duress](/physical-security/coercion-and-duress/transaction-flows-under-duress): controlled
  surrender in the signing path
- [Checklist](/physical-security/coercion-and-duress/checklist): turning these principles into sequenced work
