...
description: "Five principles for wrench-attack defense: minimization, compartmentalization, controlled surrender, resilience, and prioritization of human safety over assets."
tags:
  - Security Specialist
  - Operations & Strategy
contributors:
...
> **Key Takeaway**:
> Five principles anchor wrench-attack defense: minimization limits what any coerced individual can authorize;
> compartmentalization segments keys and roles; controlled surrender offers a believable low-value payout while real
> reserves sit behind visible delay; resilience enables recovery; prioritization always favors human safety over assets.
