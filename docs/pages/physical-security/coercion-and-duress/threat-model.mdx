...
description: "Wrench-attack threat model: opportunistic crime, organized groups, insiders, and state actors across home, work, public, and family surfaces."
tags:
  - Security Specialist
  - Operations & Strategy
contributors:
...
- [Coercion & Duress overview](/physical-security/coercion-and-duress/overview): how the pages of this sub-section fit
  together
- [Risk Factors and Early Signals](/physical-security/coercion-and-duress/risk-factors-and-early-signals): how these
  attackers select and approach targets
- [Defensive Design Principles](/physical-security/coercion-and-duress/defensive-design-principles): the controls that
  answer this threat model
- [Threat Modeling](/threat-modeling/overview): a structured method for building your own
