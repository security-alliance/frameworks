...
> **Key Takeaway**:
> During an active wrench attack, prioritize human safety first, then contain the technical surface: rotate signers,
> pause contracts where possible, coordinate with custodians and law enforcement, and preserve evidence for
> investigation.
