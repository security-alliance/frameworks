...
description: "Wrench-attack risk amplifiers and early warning: visibility, concentrated keys, geography, OSINT probing, doxxing, and surveillance indicators."
tags:
  - Security Specialist
  - Operations & Strategy
contributors:
...
- [Coercion & Duress overview](/physical-security/coercion-and-duress/overview): how the pages of this sub-section fit
  together
- [Threat Model](/physical-security/coercion-and-duress/threat-model): who acts on these signals and why
- [Personal and Family Safety](/physical-security/coercion-and-duress/personal-and-family-safety): reducing the
  exposure these factors describe
- [Digital Footprint](/privacy/digital-footprint): the public information attackers use to select targets
