...
description: "Transaction flows under duress: hard limits, delayed approvals, separated channels, plausible compliance paths, and high-risk period tightening."
tags:
  - Security Specialist
  - Engineer/Developer
  - Operations & Strategy
...
- [Coercion & Duress overview](/physical-security/coercion-and-duress/overview): how the pages of this sub-section fit
  together
- [Wallet and Key Architecture](/physical-security/coercion-and-duress/wallet-and-key-architecture): the custody split
  these flows depend on
- [Secure Multisig Best Practices](/wallet-security/secure-multisig-best-practices): thresholds and signer separation
- [Multisig for Protocols](/multisig-for-protocols/overview): timelocks and approval paths at organization scale
