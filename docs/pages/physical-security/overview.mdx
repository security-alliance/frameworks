...
description: "Physical security for crypto key-holders: coercion and duress, facility controls, counter-surveillance, and hardware supply-chain integrity."
tags:
  - Security Specialist
  - Operations & Strategy
contributors:
...
- [Operational Security](/opsec/overview) — information disclosure and routine OPSEC
- [Wallet Security](/wallet-security/overview) — technical custody and wallet controls
- [Incident Management](/incident-management/overview) — general incident response
- [Supply Chain Security](/supply-chain/overview) — software and vendor supply chain
- [Treasury Operations](/treasury-operations/overview) — organizational treasury process
