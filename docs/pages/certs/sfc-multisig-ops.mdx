...
- id: ms-3
  ...
  - id: ms-3.1.4
    description: Do you maintain documented requirements ensuring seed phrases are disaster
      resistant, geographically distributed, theft resistant, and operator loss resistant?
...
- id: ms-6
  ...
  - id: ms-6.1.3
    description: Do you maintain monitoring infrastructure and procedures to detect unauthorized,
      ...
      paths, and ensure monitoring and alerting channels are protected against tampering, with
      alerts triggered on configuration changes or unauthorized access?
