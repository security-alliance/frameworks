...
- id: ms-4
  ...
  - id: ms-4.1.7
    description: Do you require each signer to independently verify transaction details (recipient
      address, value, calldata) through a separate interface or data source before signing,
