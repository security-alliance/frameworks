...
Auditors interested in becoming accredited third-party certification issuers can apply here
...
We are currently in an Request for Comment (RFC) Phase until December 31st, 2025. We'd love to get feedback on the current 5 modular certifications we've developped, feedback on new modular certifications to develop, and more! Additionally:
- Protocols can already go through the 5 modular certifications we've created to help bring their security standards to best practices
- Protocols can sign up for the waitlist for a free 1 hour consultation with the SEAL team to walk through the proposed criteria to help you identify gaps, and help us get feedback. [On this form](https://securityalliance.typeform.com/CertsWaitlist)
- Auditors can sign up to become accreddited third party certification issuers [on this form](https://securityalliance.typeform.com/CertsAuditor)
