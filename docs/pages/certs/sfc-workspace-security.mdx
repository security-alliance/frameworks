...
- id: ws-4
  ...
  ref: /secure-software-development/secret-management
  controls:
  - id: ws-4.1.1
    description: Do you maintain procedures for credential rotation based on risk, time intervals,
      or security events?
    title: Credential Policy Requirements and Rotation
    ref: /secure-software-development/secret-management#rotation
  - id: ws-4.1.2
    ...
    ref: /secure-software-development/secret-management#storage
  - id: ws-4.2.1
    ref: # TODO
