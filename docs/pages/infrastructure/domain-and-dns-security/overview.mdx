...
description: "Protect Web3 domains from hijacking and wallet drainer attacks, with lessons from the Curve Finance and Galxe incidents and the DNS controls that stop them."
tags:
  - Engineer/Developer
  - Security Specialist
  - Operations & Strategy
