...
DNS-based Authentication of Named Entities (DANE) is an email security protocol relies on TLSA DNS records secured via DNSSEC. \
The TLSA record contains information on the MX and the certificate in use, allowing a secure connection to be made to using that certificate. \
...
Notable smaller implementers include Comcast, Protonmail and Cisco
...
- https://docs.cloud.google.com/dns/docs/dnssec-advanced#tlsa
