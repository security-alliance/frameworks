...
**Example during testing of MTA-STS**
...
**Example of MTA-STS in production**
...
An email provider attempts to deliver mail to example.com
If not already cached, the SMTP server fetches example.com's MTA-STS policy and attempts delivery using TLS according to the policy
If an issue arises a failure is logged and reported using TLS-RPT
