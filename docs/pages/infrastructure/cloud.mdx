...
description: "Secure cloud infrastructure with RBAC, MFA, encryption, VPCs, and audit logging, plus hardening guides for AWS, Azure, and GCP and open-source audit tools."
tags:
  - Engineer/Developer
  - Security Specialist
  - Operations & Strategy
