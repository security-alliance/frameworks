...
description: "Secure seed phrase management: physical written copies, metal backups, and 3-piece splitting strategies. Emergency access plans, tamper-evident bags"
tags:
  - Engineer/Developer
  - Security Specialist
  - Operations & Strategy
...
> 🔑 **Key Takeaway**: The seed phrase is complete wallet control. Keep it offline, treat any digital exposure as full
> compromise, and move funds if exposure is even suspected.
...
- [Cold vs. Hot Wallets](/wallet-security/cold-vs-hot-wallet): matching storage exposure to the value being backed up
- [Wallet and Key Architecture](/physical-security/coercion-and-duress/wallet-and-key-architecture): designing key
  layout for coercion scenarios
- [BIP-39](https://github.com/bitcoin/bips/blob/master/bip-0039.mediawiki): the mnemonic standard these phrases follow
