...
> Our website is currently unavailable. We've taken it offline while we investigate [a potential security issue /
> technical problems].
>
> Your funds in the protocol are not affected. Do not approve any transactions from sites claiming to be [protocol
> name] until we confirm service is restored.
>
