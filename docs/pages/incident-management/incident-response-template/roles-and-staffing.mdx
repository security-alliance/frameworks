...
> Whether you need formal on-call depends more on your commitments (SLAs, assets held, user expectations) than team
> size alone. Small teams with high-value assets may still need structured coverage.
