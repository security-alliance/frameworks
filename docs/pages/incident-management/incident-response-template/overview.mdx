...
This template was originally structured as an [Obsidian](https://obsidian.md/) vault. Here it is presented as a set of
Frameworks pages you can review and adapt for your own internal incident response documentation.
