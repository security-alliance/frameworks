...
> **This is a template, not a turnkey solution.** Every document, runbook, and checklist must be reviewed and customized
> for your specific protocol, team, and infrastructure. The example runbooks contain generic guidance. Do not rely on
> them without filling in your actual commands, contacts, and procedures. Test your IR capability through tabletop
...
Without a plan, you'll waste critical time figuring out *who does what* while an exploit drains funds. You can't
prevent all incidents. Focus on detecting quickly, responding effectively, and learning continuously.
...
<Checklist id="customization-checklist">
