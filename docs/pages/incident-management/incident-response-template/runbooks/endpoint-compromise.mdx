...
Two of the lures above are documented campaigns, with real message screenshots worth comparing against what
the user received. A meeting link that resolved to an unfamiliar domain, or a fake recruiter task, matches
...
follow-on accounts to check, so it is worth the two minutes.
