...
<Checklist id="step-1-take-down-or-redirect">
...
<Checklist id="step-2-warn-users">
- [ ] Post on Twitter/X
...
Message template:
> Our website may be compromised. Do NOT interact with [domain] or approve any transactions until further notice.
> Your funds in the protocol are safe if you don't sign new transactions.

### Step 3: Assess Scope

<Checklist id="step-3-assess-scope">
- [ ] What was changed?
...
<Checklist id="priority-identify-attack-vector">
...
<Checklist id="post-mitigation-investigation">
...
<Checklist id="before-restoring-service">
...
<Checklist id="affected-user-support">
