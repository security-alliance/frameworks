...
<Checklist id="perform-immediately">
...
<Checklist id="perform-in-parallel-by-role">
   - [ ] Assign members to specific roles.

</Checklist>

1. **Analysis**:
<Checklist id="perform-in-parallel-by-role-2">
...
1. **Protocol actions**:
<Checklist id="perform-in-parallel-by-role-3">
...
1. **Web actions**:
<Checklist id="perform-in-parallel-by-role-4">
...
1. **Communications**:
<Checklist id="perform-in-parallel-by-role-5">
...
- [Contacts template](/incident-management/incident-response-template/contacts):
  the contact list to have ready before you need it
- [Communications template](/incident-management/incident-response-template/communications):
  coordinating public messaging during the incident
