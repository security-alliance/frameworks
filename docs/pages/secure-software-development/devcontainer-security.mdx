...
benchmarks:
  ...
  - title: "Network Isolation"
    description: >
      By default [fully isolate devcontainers from the network](https://docs.docker.com/engine/network/drivers/none/). If network access is required, 
      allow only specific hosts or ports, avoid LAN access, and avoid binding container ports 
      to the host.

  - title: "Inspect setup scripts"
    description: >
      Review `Dockerfile`, `devcontainer.json`, and any [post-create commands](https://containers.dev/implementors/json_reference/#lifecycle-scripts).  
