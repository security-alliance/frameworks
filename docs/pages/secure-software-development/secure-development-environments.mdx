...
Importantly, while devcontainers can improve isolation, they won't always. Before running a new devcontainer you should inspect the `.devcontainer.json` to ensure sandboxing. Review [Devcontainer Security](./devcontainer-security.mdx) for more information.
