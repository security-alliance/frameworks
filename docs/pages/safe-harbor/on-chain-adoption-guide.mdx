...
1. Create your agreement: Call
   `AgreementFactory.create(AgreementDetails memory details, address chainValidator, address owner, bytes32 salt)`
...
> The V3 contracts have been audited by [Cyfrin](https://www.cyfrin.io/).
> The smart contracts are bytecode equivalent to the
> [audited hash](https://github.com/security-alliance/safe-harbor/tree/0b0abb8b627eff87e2f7b52bf8ec484cd6ce0e32).
> The audit report is available in the
> [Cyfrin audit PDF](https://github.com/security-alliance/safe-harbor/blob/main/documents/2026-01-13-cyfrin-safe-harbor-v2.0.pdf).
