...
import logo from './images/whitehat-full-logo-blue.svg'
...
<img src={logo} alt="Whitehat Logo" />
...
{/*TODO: img links (/safe-harbor/images/Uniswap_logo.png)(./images/Pendle_logo.png)(./images/Zksync_logo.png)(./images/Balancer_logo.png)*/}
| [Uniswap]() | [Pendle]() | [ZkSync]() | [Balancer]() |
|:-----------------------------------:|:----------------------------------:|:----------------------------------:|:-------------------------------------:|
