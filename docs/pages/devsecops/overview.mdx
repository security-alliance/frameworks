...
17. [Policy as Code](/devsecops/policy-as-code/overview) — Policy engines and NIST SP
    800-204D applied from commit through runtime (section hub).
18. [Repository Hardening](/devsecops/repository-hardening) — MFA, branch protection,
    CODEOWNERS, and Actions hardening.
19. [Security Testing](/devsecops/security-testing) — SAST, DAST, IAST, and fuzzing in the
    delivery path.
