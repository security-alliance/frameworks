...
description: "Canonical DevSecOps guidance for sandboxing, isolation, and containment across CI/CD, runners, tooling, and execution environments."
tags:
  - Engineer/Developer
  - Security Specialist
  - Operations & Strategy
...
This section is the canonical DevSecOps guide for **running untrusted or semi-trusted execution safely**: CI jobs, pull request validation, build scripts, plugins, package hooks, internal automation, and AI agents (as one automation category among many).
