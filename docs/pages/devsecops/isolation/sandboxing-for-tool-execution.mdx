...
> 🔑 **Key Takeaway**
>
> - Treat every tool invocation as untrusted until policy checks approve it.
> - Add stronger gates and isolation for high-impact actions such as deploy, merge, and publish.
> - Require auditable identity plus execution logs for every side effect.
