...
> - Segment trust zones to block lateral movement from compromised workloads.
> - Enforce hard CPU, memory, process, timeout, and concurrency limits to contain abuse.
