...
> - Enforce controls before execution, during runtime, and before promotion or deploy.
> - Use both layers together to close gaps either control leaves on its own.
