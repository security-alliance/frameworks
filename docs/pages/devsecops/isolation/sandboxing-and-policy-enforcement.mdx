...
> 🔑 **Key Takeaway**: Policy decides what may run and sandboxing limits damage if it fails,
> so both must be enforced before, during, and after execution to close control gaps.
