...
> *Note:* Rego examples on this page are fenced as `python`, because the site's syntax
> highlighter has no Rego grammar and an unrecognized language fails the build.
