...
- [Execution Sandboxing](/devsecops/execution-sandboxing) — principles and runtime design choices.
- [Execution Sandboxing: A Practical Guide](/devsecops/execution-sandboxing-practical-guide) — implementation blueprint for teams and platforms.
- [Network & Resource Isolation](/devsecops/network-and-resource-isolation) — egress controls, quotas, and anti-exfiltration patterns.
- [Sandboxing for Tool Execution](/devsecops/sandboxing-for-tool-execution) — controlling high-risk tool calls and side effects.
- [Capability-Based Isolation](/devsecops/capability-based-isolation) — breaking broad permissions into constrained capabilities.
- [Sandboxing & Policy Enforcement](/devsecops/sandboxing-and-policy-enforcement) — integrating policy-as-code with runtime isolation.
