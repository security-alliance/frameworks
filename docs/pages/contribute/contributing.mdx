...
import { ContributeFooter } from '../../../components'
...
> earns badges on your contributor profile in the [Spotlight Zone](/contribute/spotlight-zone). For the rules on each
...
| Concern | Authority |
| --- | --- |
| Page types, required sections, overview maps, exceptions | [Content model](/contribute/content-model) |
| Voice, modality, terminology | [Style and terminology](/contribute/style-and-terminology) |
...
| Framework normalization PRs | [Docs normalization checklist](/contribute/docs-normalization-checklist) |
...
it, and the Security Frameworks need all three to be worth trusting. What follows is about describing different kinds
of work accurately, not about ranking contributors.
...
- **Not being listed on a page is not a snub.** Every merged PR counts toward your profile on the
  [Spotlight Zone](/contribute/spotlight-zone) and the badges shown there (first contribution, then 5, 10, and 25
...
also **update `vocs.config.ts`** so that the page appears in the site's sidebar. New content should always be added
...
[Style and terminology](/contribute/style-and-terminology). Structural rules live in the
...
- Opening structure and Key Takeaway format: see the [content model](/contribute/content-model)

### Content standardization (summary)

- **American English** and the [canonical terminology table](/contribute/style-and-terminology#canonical-terminology)
...
Funding the work is another way to contribute. [Support the Frameworks](https://securityalliance.org/donate) to help
keep them free, open, and independent.
