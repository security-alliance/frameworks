...
- If someone already has an open PR, you can also review the live Vercel preview deployment and leave proofreading or
  feedback comments there directly without preparing your own PR
...
4. **Open a Pull Request (PR) against the `develop` branch** of this repository. Once submitted, you can use the live
   Vercel preview deployment to make final adjustments and leave comments there directly for feedback or proofreading,
   in addition to the PR review workflow.
