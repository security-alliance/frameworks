---
title: "Guidelines"
description: "Set up effective on-chain monitoring: define critical metrics like large fund transfers and token minting events, implement automated tools, establish real-time alerts via email, SMS, and messaging apps."
tags:
  - Engineer/Developer
  - Security Specialist
---
