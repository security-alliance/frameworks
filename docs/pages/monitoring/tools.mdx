...
Real-time transaction screening middleware. Uses simulation-based detection to identify threats before transactions
are confirmed on-chain. Governed by FORT token holders, with open-source detection agents.

- **Chains:** EVM-compatible networks
- **GitHub:** [forta-network/forta-core-go](https://github.com/forta-network/forta-core-go)
