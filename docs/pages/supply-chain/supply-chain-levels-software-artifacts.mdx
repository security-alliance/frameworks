...
description: "Classify software components by risk level, from value-handling libraries down to local build tooling, and apply proportional controls across your dependency tree."
tags:
  - Engineer/Developer
  - Security Specialist
contributors:
...
User-facing front-end dependencies that influence wallet connection, transaction construction, signing flows, or
security-critical UI should be treated as high-risk or critical, even if they are "just front-end libraries".
