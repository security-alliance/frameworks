...
Discord server security spans account hygiene, role architecture, server hardening, and bot management — each covered in depth in the [Discord Security Guide](https://frameworks.securityalliance.dev/guides/account-management/discord). Use this page to find the right section.
...
|---|---|---|
| **Role permissions** | Restrict Administrator, Manage Webhooks, Manage Server, Manage Roles, and Manage Channels to the minimum required roles | [Role permissions →](https://frameworks.securityalliance.dev/guides/account-management/discord#roles) |
| **Cold Admin account** | A dedicated owner account on a factory-reset device, used only for major changes and incident recovery | [Cold Admin →](https://frameworks.securityalliance.dev/guides/account-management/discord#cold-admin-setup) |
| **Verification level** | Set to at least Medium (5+ minutes on Discord) — Moderate recommended for public servers | [Verification →](https://frameworks.securityalliance.dev/guides/account-management/discord#member-screening-setup) |
| **Raid protection** | ML-based join-raid detection with auto-lockdown and CAPTCHA for new users | [Raid protection →](https://frameworks.securityalliance.dev/guides/account-management/discord#safety-setup) |
| **AutoMod rules** | Block spam, harmful links, mention spam, and impersonation keywords in usernames | [AutoMod →](https://frameworks.securityalliance.dev/guides/account-management/discord#automod) |
| **Anti-impersonation** | Custom rules blocking lookalike usernames and profile pictures; bots like Wick | [Anti-impersonation →](https://frameworks.securityalliance.dev/guides/account-management/discord#anti-impersonation-bots) |
| **Bot & integration security** | Apply least privilege to bots; restrict command permissions; audit webhooks | [Integrations →](https://frameworks.securityalliance.dev/guides/account-management/discord#additional-recommendations) |

---

> Spotted an error or have ideas to enhance this content? Your contributions are valuable to us.

For a comprehensive guide on securing your Discord server, see the [**Discord Security Guide**](https://frameworks.securityalliance.dev/guides/account-management/discord).
