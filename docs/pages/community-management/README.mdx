...
- Use unique, complex passwords for each service and store them securely in a reputable password manager. Refer to the [**Operational Security Framework**](/opsec/README) and [**Wallet Security Framework**](/wallet-security/README) for more information on this.
...
Refer to the [**Security Awareness framework**](/awareness/README) to learn more about social engineering techniques and security training best practices.
...
For a comprehensive understanding of Operational Security, including additional strategies and guidelines, please refer to the dedicated [**Operational Security framework**](/opsec/README).
